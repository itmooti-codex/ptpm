  ...
  if (!modal) {
    ...
    modal.innerHTML = `
      <div class="bg-white rounded-lg shadow-lg max-w-4xl w-[95vw] max-h-[90vh] overflow-hidden relative hover:!bg-white active:!bg-white hover:bg-white active:bg-white focus:bg-white focus-visible:bg-white hover:shadow-lg active:shadow-lg focus:shadow-lg focus-visible:shadow-lg">
        <button type="button" data-file-preview-close class="!absolute !top-3 !right-3 !text-slate-500 hover:!text-slate-700 hover:!text-slate-500 active:!text-slate-500 hover:!text-slate-500 active:!text-slate-500 focus:!text-slate-500 focus-visible:!text-slate-500">
  ...
  modal.innerHTML = `
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 overflow-hidden hover:!bg-white active:!bg-white hover:bg-white active:bg-white focus:bg-white focus-visible:bg-white hover:shadow-xl active:shadow-xl focus:shadow-xl focus-visible:shadow-xl">
      <div class="flex items-start justify-between px-4 py-3 border-b border-slate-200 hover:!border-slate-200 active:!border-slate-200 hover:border-b active:border-b focus:border-b focus-visible:border-b hover:border-slate-200 active:border-slate-200 focus:border-slate-200 focus-visible:border-slate-200">
        ...
        <button type="button" data-unsaved-close class="!text-slate-500 hover:!text-slate-700 hover:!text-slate-500 active:!text-slate-500 hover:!text-slate-500 active:!text-slate-500 focus:!text-slate-500 focus-visible:!text-slate-500">
      ...
      <div class="px-4 py-5 space-y-4 text-left hover:text-left active:text-left focus:text-left focus-visible:text-left">
        ...
        <div class="flex justify-end gap-3">
          <button type="button" data-unsaved-discard class="!px-4 !py-2 !rounded !border !border-red-500 !text-red-600 hover:!bg-red-50 !text-sm !font-semibold hover:!border-red-500 active:!border-red-500 hover:!text-red-600 active:!text-red-600 hover:!border active:!border focus:!border focus-visible:!border hover:!border-red-500 active:!border-red-500 focus:!border-red-500 focus-visible:!border-red-500 hover:!text-red-600 active:!text-red-600 focus:!text-red-600 focus-visible:!text-red-600 hover:!text-sm active:!text-sm focus:!text-sm focus-visible:!text-sm">Discard Changes</button>
          <button type="button" data-unsaved-save class="!px-4 !py-2 !rounded !bg-[#003882] !text-white hover:!bg-[#0b4b9f] !text-sm !font-semibold hover:!bg-[#003882] active:!bg-[#003882] hover:!text-white active:!text-white hover:!bg-[#003882] active:!bg-[#003882] focus:!bg-[#003882] focus-visible:!bg-[#003882] hover:!text-white active:!text-white focus:!text-white focus-visible:!text-white hover:!text-sm active:!text-sm focus:!text-sm focus-visible:!text-sm">Save & Exit</button>
        </div>
      </div>
    </div>
  `;
  ...
  modal.innerHTML = `
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 overflow-hidden hover:!bg-white active:!bg-white hover:bg-white active:bg-white focus:bg-white focus-visible:bg-white hover:shadow-xl active:shadow-xl focus:shadow-xl focus-visible:shadow-xl">
      <div class="flex items-start justify-between px-4 py-3 border-b border-slate-200 hover:!border-slate-200 active:!border-slate-200 hover:border-b active:border-b focus:border-b focus-visible:border-b hover:border-slate-200 active:border-slate-200 focus:border-slate-200 focus-visible:border-slate-200">
        ...
        <button type="button" data-reset-close class="!text-slate-500 hover:!text-slate-700 hover:!text-slate-500 active:!text-slate-500 hover:!text-slate-500 active:!text-slate-500 focus:!text-slate-500 focus-visible:!text-slate-500">
          <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15 5L5 15M5 5L15 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </button>
      ...
      <div class="flex justify-end gap-3 px-4 py-3 border-t border-slate-200 hover:!border-slate-200 active:!border-slate-200 hover:border-t active:border-t focus:border-t focus-visible:border-t hover:border-slate-200 active:border-slate-200 focus:border-slate-200 focus-visible:border-slate-200">
          <button type="button" data-reset-cancel class="!px-4 !py-2 !rounded !text-slate-700 hover:!bg-slate-50 !text-sm !font-semibold hover:!text-slate-700 active:!text-slate-700 hover:!text-slate-700 active:!text-slate-700 focus:!text-slate-700 focus-visible:!text-slate-700 hover:!text-sm active:!text-sm focus:!text-sm focus-visible:!text-sm">Cancel</button>
          <button type="button" data-reset-confirm class="!px-4 !py-2 !rounded !bg-red-600 !text-white hover:!bg-red-700 !text-sm !font-semibold hover:!bg-red-600 active:!bg-red-600 hover:!text-white active:!text-white hover:!bg-red-600 active:!bg-red-600 focus:!bg-red-600 focus-visible:!bg-red-600 hover:!text-white active:!text-white focus:!text-white focus-visible:!text-white hover:!text-sm active:!text-sm focus:!text-sm focus-visible:!text-sm">Reset</button>
        </div>
    </div>
  `;
  ...
  card.innerHTML = `
    <div class="flex flex-row justify-between items-center">
      ...
      <div class="flex items-center gap-3">
        <button type="button" data-upload-action="view" class="!text-sky-700 hover:!text-sky-900 hover:!text-sky-700 active:!text-sky-700 hover:!text-sky-700 active:!text-sky-700 focus:!text-sky-700 focus-visible:!text-sky-700" title="Preview">
          <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button type="button" data-upload-action="delete" class="!text-rose-600 hover:!text-rose-700 hover:!text-rose-600 active:!text-rose-600 hover:!text-rose-600 active:!text-rose-600 focus:!text-rose-600 focus-visible:!text-rose-600" title="Delete">
    ...
    modal.innerHTML = `
      <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 overflow-hidden hover:!bg-white active:!bg-white hover:bg-white active:bg-white focus:bg-white focus-visible:bg-white hover:shadow-xl active:shadow-xl focus:shadow-xl focus-visible:shadow-xl">
        <div class="flex items-start justify-between px-4 py-3 border-b border-slate-200 hover:!border-slate-200 active:!border-slate-200 hover:border-b active:border-b focus:border-b focus-visible:border-b hover:border-slate-200 active:border-slate-200 focus:border-slate-200 focus-visible:border-slate-200">
          ...
          <button type="button" data-alert-close class="!text-slate-500 hover:!text-slate-700 hover:!text-slate-500 active:!text-slate-500 hover:!text-slate-500 active:!text-slate-500 focus:!text-slate-500 focus-visible:!text-slate-500">
            <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 5L5 15M5 5L15 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </button>
        ...
        <div class="px-4 py-5 space-y-4 text-left hover:text-left active:text-left focus:text-left focus-visible:text-left">
          ...
          <div class="flex justify-end gap-3">
            <button type="button" data-alert-confirm class="!px-4 !py-2 !rounded !bg-[#003882] !text-white hover:!bg-[#0b4b9f] !text-sm !font-semibold hover:!bg-[#003882] active:!bg-[#003882] hover:!text-white active:!text-white hover:!bg-[#003882] active:!bg-[#003882] focus:!bg-[#003882] focus-visible:!bg-[#003882] hover:!text-white active:!text-white focus:!text-white focus-visible:!text-white hover:!text-sm active:!text-sm focus:!text-sm focus-visible:!text-sm">OK</button>
          </div>
        </div>
      </div>
    `;
