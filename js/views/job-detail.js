                ...
                <div class="flex flex-col gap-1">
                  ...
                  <div class="relative">
                    <select
                      ...
                      class="appearance-none w-full px-3 py-2.5 bg-white rounded outline outline-1 outline-gray-300 text-slate-700 pr-10 hover:!bg-white active:!bg-white hover:!text-slate-700 active:!text-slate-700 outline-offset-[-1px]"
                    >
      ...
      <div class="bg-white rounded-lg outline outline-1 outline-gray-300 w-full hover:!bg-white active:!bg-white">
        ...
        <div class="p-4 flex flex-col gap-4">
          ...
          <div class="border-t border-gray-200 pt-6 pb-4 flex flex-col items-center gap-4 hover:!border-gray-200 active:!border-gray-200">
            <div data-invoice-placeholder class="flex flex-col w-fit gap-7 py-5 bg-slate-100 rounded-md items-center justify-center text-neutral-500 text-sm hover:!bg-slate-100 active:!bg-slate-100 hover:!text-neutral-500 active:!text-neutral-500">
          ...
          <div class="hidden grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <div class="flex flex-col gap-1">
              ...
              <div class="relative">
                <select data-field="payment_method" class="appearance-none w-full px-3 py-2.5 bg-white rounded outline outline-1 outline-gray-300 text-slate-700 pr-10 hover:!bg-white active:!bg-white hover:!text-slate-700 active:!text-slate-700 outline-offset-[-1px]"></select>
        ...
        <div class="py-6 space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <label class="block">
              ...
              <select class="w-full rounded border border-neutral-300 px-3 py-2 hover:!border-neutral-300 active:!border-neutral-300 outline outline-1 outline-offset-[-1px] outline-gray-300">
