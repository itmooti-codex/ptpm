        ...
        const dayCols = row
          .map((day) => {
            ...
            return `
              ...
              >
                <div class="self-stretch px-2 sm:px-3 py-2 sm:py-3 border-r border-t border-b ${cellBorder} inline-flex justify-center items-center gap-1 sm:gap-2 ${headerState} text-xs sm:text-sm font-medium leading-5 sm:leading-4 whitespace-nowrap hover:border-r active:border-r focus:border-r focus-visible:border-r hover:border-t active:border-t focus:border-t focus-visible:border-t hover:border-b active:border-b focus:border-b focus-visible:border-b hover:text-xs active:text-xs focus:text-xs focus-visible:text-xs hover:sm:text-sm active:sm:text-sm focus:sm:text-sm focus-visible:sm:text-sm">
                  ${day.label}
                </div>
                <div class="h-[50px] self-stretch px-2 sm:px-3 py-2 sm:py-3 ${valueState} border-r border-b ${cellBorder} inline-flex justify-center items-center gap-2 sm:gap-3 hover:border-r active:border-r focus:border-r focus-visible:border-r hover:border-b active:border-b focus:border-b focus-visible:border-b">
                  <div class="text-xs sm:text-sm font-normal leading-5 tracking-tight whitespace-nowrap hover:text-xs active:text-xs focus:text-xs focus-visible:text-xs hover:sm:text-sm active:sm:text-sm focus:sm:text-sm focus-visible:sm:text-sm">
